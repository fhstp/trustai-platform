...
if __name__ == "__main__":
    ...
    if args.check:
        print('Check "' + DogCatModel.__name__ + '" instance creation..')
        model = DogCatModel(**kwargs)

    app = init_app(model_class=DogCatModel, basic_auth_user=args.basic_auth_user, basic_auth_pass=args.basic_auth_pass)

    app.run(host=args.host, port=args.port, debug=args.debug)

else:
    # for uWSGI use
    app = init_app(model_class=DogCatModel)
